...
def driver_monitoring(started: bool, params: Params, CP: car.CarParams) -> bool:
  return driverview(started, params, CP) and not params.get_bool("DisableDriverMonitoring")
...
procs = [
  ...
  PythonProcess("researchcaptured", "openpilot.sunnypilot.system.research_capture", always_run),
...
if os.path.exists("../../third_party/copyparty/copyparty-sfx.py"):
  ...
  copyparty_args += [f"-v{Paths.research_capture_root()}:/captures:r"]
